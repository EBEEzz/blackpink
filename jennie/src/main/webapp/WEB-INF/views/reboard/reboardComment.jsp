...
<c:if test="${not empty SID}">
		...
		<div class="w3-col w3-margin-top w3-card-4">
			<div class="w3-third w3-green w3-hover-lime w3-button" id="listbtn">리스트</div>
			<div class="w3-third w3-blue w3-hover-aqua w3-button" id="rbtn">리셋</div> 
			<div class="w3-third w3-deep-orange w3-hover-orange w3-button" id="cmtbtn">댓글등록</div> 
		</div>
